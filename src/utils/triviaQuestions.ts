...
export const triviaQuestions: TriviaQuestion[] = [
  ...
  {
    id: '19',
    question: 'Answer these true/false questions quickly!',
    type: 'true-false-blitz',
    trueFalseQuestions: [
      ...
      { question: 'Elephants are small', answer: false }
    ],
    correctAnswer: [0, 1, 0, 0, 1], // 0 = true, 1 = false
    category: 'General',
    difficulty: 'easy'
  },
  ...
  // Medium True/False Blitz
  {
    id: '59',
    question: 'Answer these science true/false questions quickly!',
    type: 'true-false-blitz',
    trueFalseQuestions: [
      ...
      { question: 'Gold is magnetic', answer: false },
      { question: 'Light travels faster than sound', answer: true }
    ],
    correctAnswer: [0, 1, 0, 1, 0], // 0 = true, 1 = false
    category: 'Science',
    difficulty: 'medium'
  },
  ...
  // Hard True/False Blitz
  {
    id: '69',
    question: 'Answer these advanced true/false questions quickly!',
    type: 'true-false-blitz',
    trueFalseQuestions: [
    ...
    correctAnswer: [0, 1, 1, 0, 1], // 0 = true, 1 = false
    category: 'General',
    difficulty: 'hard'
  },
...
export const checkAnswer = (question: TriviaQuestion, userAnswer: string | number | number[]): boolean => {
  ...
  } else if (question.type === 'true-false-blitz') {
